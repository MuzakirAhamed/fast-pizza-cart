...
export default function Button({ children, type, to, onClick }) {
  ...
  const styles = {
    ...
    round: base + "px-2.5 py-1 md:px-3.5 md:py-2 text-sm hover:bg-yellow-300 transition-colors duration-300 focus:ring focus:outline-none focus:ring-offset-2 focus:ring-yellow-500 active-bg-yellow-700",
  };
  if (to) {
    return (
